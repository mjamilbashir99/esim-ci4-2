    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url('admin/dashboard') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Hotelbeds</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= site_url('admin/hotels') ?>">Hotels</a>
                        <!-- <a class="collapse-item" href="utilities-animation.html">Flight</a> -->
                    </div>
                </div>
            </li>
            <li class="nav-item">
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Hotelbeds 2025</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
